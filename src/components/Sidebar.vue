<template>
<aside :class="isCollapsed ? 'fixed left-0 top-0 h-screen bg-[#1a2a3a] text-white transition-all duration-300 z-50 flex flex-col w-16' : 'fixed left-0 top-0 h-screen bg-[#1a2a3a] text-white transition-all duration-300 z-50 flex flex-col w-64'">
  ...
  <div class="relative">
    ...
    <input placeholder="Search anything..." class="pl-10 pr-4 py-3 bg-[#2D3A4F] rounded-lg shadow-md transition-all w-full text-sm text-white placeholder-slate-400" type="text">
        ...
        <nav class="flex-1 px-4 mt-8 space-y-1">
          ...
          <router-link
            to="/"
        class="w-full flex items-center justify-between px-3 py-3 rounded-xl transition-all group text-slate-400 hover:bg-blue-600/20 hover:text-blue-400 hover:border-l-4 hover:border-blue-500 active:bg-blue-600/20 active:text-blue-400 active:border-l-4 active:border-blue-500">
          ...
          <router-link
            ...
            class="w-full flex items-center justify-between px-3 py-3 rounded-xl transition-all group text-slate-400 hover:bg-blue-600/20 hover:text-blue-400 hover:border-l-4 hover:border-blue-500 active:bg-blue-600/20 active:text-blue-400 active:border-l-4 active:border-blue-500">
              <div class="flex items-center gap-4">
                <div class="min-w-[20px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-folder-kanban h-5 w-5 shrink-0"><path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13c0 1.1.9 2 2 2Z"></path><path d="M8 10v4"></path><path d="M12 10v2"></path><path d="M16 10v6"></path>
                </svg>
                </div>
                <span v-if="!isCollapsed" class="text-sm font-medium whitespace-nowrap"> Projects</span>
              </div>
              <div v-if="!isCollapsed">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right" aria-hidden="true"><path d="m9 18 6-6-6-6" />
                </svg>
        ...
        class="w-full flex items-center justify-between px-3 py-3 rounded-xl transition-all group text-slate-400 hover:bg-blue-600/20 hover:text-blue-400 hover:border-l-4 hover:border-blue-500 active:bg-blue-600/20 active:text-blue-400 active:border-l-4 active:border-blue-500">
          <div class="flex items-center gap-4">
            <div class="min-w-[20px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-square-check-big h-5 w-5 shrink-0"><path d="M21 10.5V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.5"></path><path d="m9 11 3 3L22 4"></path></svg>
   ...
   class="w-full flex items-center justify-between px-3 py-3 rounded-xl transition-all group text-slate-400 hover:bg-blue-600/20 hover:text-blue-400 hover:border-l-4 hover:border-blue-500 active:bg-blue-600/20 active:text-blue-400 active:border-l-4 active:border-blue-500">
    ...
    to="/Finance"
        ...
        <div class="flex items-center gap-4">
          <div class="min-w-[20px]">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-wallet h-5 w-5 shrink-0"><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1"></path><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"></path>
            </svg>
        </div>
   ...
   to="/Message"
        ...
        <div class="flex items-center gap-4">
          <div class="min-w-[20px]">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square h-5 w-5 shrink-0"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
          </div>
      ...
      <button class="w-full flex items-center justify-between px-3 py-3 rounded-xl transition-all group text-slate-400 hover:bg-blue-600/20 hover:text-blue-400 hover:border-l-4 hover:border-blue-500 active:bg-blue-600/20 active:text-blue-400 active:border-l-4 active:border-blue-500">
        <div class="flex items-center gap-4">
          <div class="min-w-[20px]">
           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-column h-5 w-5 shrink-0"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg>
          </div>
...
<div class="p-4 border-t border-slate-700/50 space-y-4">
 ...
 to="/AccountSettings"
  class="w-full flex items-center justify-between px-3 py-2 text-slate-400 hover:text-white transition-colors">
    <div class="flex items-center gap-4">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-settings" aria-hidden="true"><path d="M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"></path><circle cx="12" cy="12" r="3"></circle>
      </svg>
